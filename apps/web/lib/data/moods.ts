...
// настроения на карточке профиля. Когда мир станет реактивным, выбор партнёра
// придёт сюда как данные, а не как правки layout — тот же паттерн, что в
// liveliness.ts и worldStatus.ts.
